/* =========================================================
   SECURENEST — SERVICE PAGES JS V2
   ========================================================= */
...
(() => {
    ...
    function initServiceHero() {
        ...
        /*
         * Не оставляем Hero пустым,
         * даже если путь к фото временно неверный.
         */
    ...
    /* =====================================================
       ...
       Слайды-дубликаты создаются ДО Swiper,
       чтобы loop не отключался при небольшом
       количестве оригинальных карточек.
       ===================================================== */
    ...
    function ensureLoopSlides(
        ...
        /*
         * Не клонируем повторно,
         * если функция была вызвана ещё раз.
         */
    ...
    /* =====================================================
       SERVICE SCENES SWIPER

       Active slide expands wider.
       ===================================================== */
    ...
    function initServiceScenes() {
        ...
        sliders.forEach(
            (slider) => {
                ...
                /*
                 * Не даём AOS считать размеры
                 * до окончательной геометрии Swiper.
                 */
    ...
    /* =====================================================
       ...
       Не держим desktop parallax
       после перехода на мобильный размер.
       ===================================================== */
