...
(() => {
    ...
    function applyEmail() {
        ...
        /*
         * ВАЖНО:
         * data-config-email-link меняет ТОЛЬКО href.
         *
         * Поэтому кнопка "Email Us" на legal pages
         * не превращается в голый email.
         */
